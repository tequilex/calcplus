...
export default function NotFound() {
  return (
    <div className="max-w-[768px] mx-auto px-4 md:px-6 py-24 text-center">
      <p className="text-[13px] text-muted-foreground uppercase tracking-[0.08em] font-medium mb-4">
        Ошибка 404
      </p>
      <h1 className="text-[32px] font-medium text-foreground mb-4 tracking-tight">
        Страница не найдена
      </h1>
      <p className="text-muted-foreground mb-8 max-w-[40ch] mx-auto leading-relaxed">
